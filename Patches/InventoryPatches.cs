...
//            InventorySlot10Action.Enable();
        ...
        [HarmonyPostfix]
        static void PatchGrabObjectClientRpc(GameNetcodeStuff.PlayerControllerB __instance,bool __0,global::Unity.Netcode.NetworkObjectReference __1)
        {
            try
            {
                if (!__0)
                ...
                if (!__1.TryGet(out global::Unity.Netcode.NetworkObject networkObject))
                    return;
                ...
                if (field == null)
                {
                    Plugin.Log.LogWarning("Could not find PlayerControllerB.currentlyGrabbingObject");
                    return;
                }

                field.SetValue(__instance, grabbableObject);
            }
            catch (Exception e)
            {
                Plugin.Log.LogWarning("GrabObjectClientRpc postfix failed: " + e);
            }
        }
